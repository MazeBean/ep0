...
const SLOTS = ['train', 'fuel', 'vitals', 'vee', 'brand', 'water', 'peak', 'finance'] as const
  ...
  (server) => {
    server.registerTool(
      'list_slots',
      {
        ...
        description:
          'READ. List the eight dashboard tile slots (train, fuel, vitals, vee, brand, water, peak, finance) and whether each currently holds a tile.',
        inputSchema: {},
      },
