...
const SLOTS = ['train', 'fuel', 'vitals', 'vee', 'brand', 'water', 'todoist', 'peak', 'finance'] as const
  ...
  (server) => {
    server.registerTool(
      'list_slots',
      {
        ...
        description:
          'READ. List the nine dashboard tile slots (train, fuel, vitals, vee, brand, water, todoist, peak, finance) and whether each currently holds a tile.',
        inputSchema: {},
      },
