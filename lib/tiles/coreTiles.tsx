...
export const CORE_TILES: Record<CoreTileId, CoreTile> = {
  ...
  fuel: {
    ...
    glyph: (
      <svg viewBox="-12 -12 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" strokeLinecap="round">
        <path d="M0 -2 C-1.5 -4 -4 -5 -6.5 -3.5 C-9 -2 -9.5 2 -7 5 C-5 7.5 -2 8 0 6.5 C2 8 5 7.5 7 5 C9.5 2 9 -2 6.5 -3.5 C4 -5 1.5 -4 0 -2 Z" />
        <path d="M0 -2 C0 -4 0.5 -6 1.5 -7.5" />
        <path d="M1.5 -7 C3.5 -8.5 6 -7.5 5.5 -5.5 C4 -6 2 -6.5 1.5 -7 Z" />
      </svg>
    ),
    art: (
  ...
  water: {
    ...
    defaultSize: 'tall',
    glyph: (
      <svg viewBox="-12 -12 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round">
        <circle cx="0" cy="0" r="3" strokeWidth="1.4" />
        <circle cx="0" cy="0" r="7" strokeWidth="1.1" opacity="0.6" />
        <circle cx="0" cy="0" r="10.5" strokeWidth="0.9" opacity="0.35" />
      </svg>
    ),
    art: (
      <svg className="art" viewBox="0 0 210 250">
        <path className="mot" d="M40 128 Q75 108 105 128 T170 128" />
        <path className="motd" d="M40 153 Q75 133 105 153 T170 153" />
        <g className="orb"><circle className="glow" r="10" /><circle className="node" r="3.4" /></g>
      </svg>
    ),
  },
  ...
  goals: {
    ...
    glyph: (
      <svg viewBox="-12 -12 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
        <path d="M-7 10 L-7 -9 L7 -6 L-2 -2 L7 2 L-7 5" />
      </svg>
    ),
    art: (
      <svg className="art" viewBox="0 0 210 250">
        <circle className="motd" cx="105" cy="120" r="46" /><circle className="motd" cx="105" cy="120" r="26" />
        <g className="orb"><circle className="glow" r="10" /><circle className="node" r="3.4" /></g>
      </svg>
    ),
  },
  workout: {
    ...
    art: (
      <svg className="art" viewBox="0 0 210 250">
        <path className="mot" d="M40 190 L80 165 L110 175 L145 130 L175 140 L200 95" />
        <g className="orb"><circle className="glow" r="10" /><circle className="node" r="3.4" /></g>
      </svg>
    ),
  },
  ...
  intake: {
    ...
    art: (
      <svg className="art" viewBox="0 0 210 250">
        <path className="mot" d="M40 150 Q75 90 105 120 T170 70" />
        <g className="orb"><circle className="glow" r="10" /><circle className="node" r="3.4" /></g>
      </svg>
    ),
  },
